...
const social = computed(() => {
    if (options.value.footerSocial === false) {
        return [];
    }
...
<template>
  <footer
    v-if="visible"
    class="VPFooter ff-footer"
    :class="{ 'has-sidebar': hasSidebar }"
  >
    <div class="ff-footer-container">
      <div
        v-if="columns.length || social.length"
        class="ff-footer-top"
      >
        <div
          v-if="columns.length"
          class="ff-footer-columns"
        >
          <div
            v-for="column in columns"
            :key="column.title"
            class="ff-footer-column"
          >
            <p class="ff-label">
              {{ column.title }}
            </p>
        ...
        <div
          v-if="social.length"
          class="ff-footer-column ff-footer-social"
        >
          <p class="ff-label">
            {{ labels.footerSocial }}
          </p>
