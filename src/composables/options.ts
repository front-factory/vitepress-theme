...
import type { ThemeConfig, ThemeLabels, ThemeOptions } from '../types'
...
export function useLabels() {
    ...
    return computed<Required<ThemeLabels>>(() => {
        ...
        for (const [key, value] of Object.entries(options.value.labels ?? {})) {
            if (value) labels[key as keyof ThemeLabels] = value
        }
